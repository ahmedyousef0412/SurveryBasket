...
public static class Permessions
{

    public static string Type { get; } = "permessions";
    ...
    public static IList<string?> GetAllPermesions() =>
        typeof(Permessions).GetFields().Select(f => f.GetValue(f) as string).ToList();
}
